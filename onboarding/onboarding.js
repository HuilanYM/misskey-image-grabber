...
const I18N = {
  'zh-CN': {
    ...
    wn0220: '全新应用图标：绿色相框与下载徽章，与扩展的抓取主题一致',
  ...
  ja: {
    ...
    wn0220: '新しいアプリアイコン：緑のフォトフレームとダウンロードバッジ',    wn010: '初回リリース：取得 · 安全プリセット · オフライン HTML アーカイブ',
  ...
  en: {
    ...
    wn0220: 'New app icon: green photo frame with a download badge, matching the grab theme',    wn010: 'First release: grabbing · safety presets · offline HTML archive',
