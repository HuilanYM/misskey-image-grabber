...
const I18N = {
  ...
  ja: {
    ...
    wn0219: '「高速」プリセットのペースを引き締め：リクエスト間隔を倍にし、バッチ休憩を追加。インスタンスへの負荷と速度のバランスを再調整',    wn010: '初回リリース：取得 · 安全プリセット · オフライン HTML アーカイブ',
  ...
  en: {
    ...
    wn0219: 'Tightened the "fast" preset pacing: doubled request intervals and added batch rests, rebalancing speed vs. instance load',    wn010: 'First release: grabbing · safety presets · offline HTML archive',
